...
export default function ViewHolidayCard() {
   const { setOpenDrawer, setDrawerView } = useAppointmentDrawerStore((state) => state)
   const { selectedHolidayId, holidays, setCalendarItemAction } = useAppointmentPanelStore(
      (state) => state,
   )
      ...
      <div>
         <div className="flex items-start justify-between p-10">
            ...
            <div className="flex gap-4">
               <Button variant="icon" onClick={handleEditHoliday}>
